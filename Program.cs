...
namespace odev
{
    public static class Program
    {
     static void Main(string[] args)
        ...
        foreach (int ciftler in ciftSayilar)
        {
        ...
        Console.WriteLine("Girilen sayılardan ikinci sayıya eşit olan veya tam bölünenler");
...
////////////////////////////
        ...
        Console.WriteLine("Girilen kelime Sayısı = "+kelime_sayisi.Length);
        
        int harf_sayisi = 0;
        for(int i = 0; i < kelime_sayisi.Length;i++)
        {
            harf_sayisi += kelime_sayisi[i].Length;
        }
        Console.WriteLine("Toplam karakter Sayısı= " +harf_sayisi);
        }
    }
}
